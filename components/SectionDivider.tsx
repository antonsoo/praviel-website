...
export default function SectionDivider() {
  return (
    <div className="relative isolate flex h-24 items-center justify-center overflow-hidden">
      <div
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative z-10 flex items-center gap-5 text-sm uppercase tracking-[0.6em] text-[#E8C55B]/45">
        {SYMBOLS.map((symbol) => (
          <span key={symbol} className="animate-divider-symbol select-none">
            {symbol}
          </span>
        ))}
      </div>
