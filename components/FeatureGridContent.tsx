    ...
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
        {features.map((feature) => (
          <article
            key={feature.title}
            className="group relative flex flex-col rounded-2xl border border-[#D4AF37]/15 bg-zinc-900/70 p-6 text-left shadow-lg shadow-black/30 transition-transform duration-300 ease-out hover:-translate-y-2 hover:border-[#D4AF37]/40 hover:shadow-2xl hover:shadow-[#D4AF37]/25 scroll-fade-in coin-flip-hover"
          >
